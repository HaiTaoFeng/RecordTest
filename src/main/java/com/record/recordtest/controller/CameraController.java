package com.record.recordtest.controller;
...
import static com.record.recordtest.MainActivity.START_RECORD;
...
public class CameraController {
    ...
    public void takePicture(Handler mHandler,boolean isRecording) {
        this.mHandler = mHandler;
        this.isRecording = isRecording;
        if (permissionsManager.checkCameraPermission(mActivity)) {
            lockFocus();
        }else{
            Toast.makeText(mActivity,"权限不足，请先开启权限！",Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        mMediaRecorder.setVideoEncodingBitRate(3*1024*1024);//设置录制的视频编码比特率
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            cameraDevice.close();
            mCameraDevice = null;
            Toast.makeText(mActivity,"相机设备使用出错："+ error,Toast.LENGTH_LONG).show();
        }
    };
